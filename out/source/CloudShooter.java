...
//Inicializar Objetos
 ...
 public void draw() { //desenhar os elementos do programa no ecra mediante condicoes especificadas
  ...
  if (m.i.active) { //instrucoes ativos
    ...
    for (int i = 0; i < PApplet.parseInt(p1.level*10); i++) { //precorrer o tamanho do array de inimigos
 ...
 public void changeBulletSizeOnDifficultyChange(){ // mudar o tipo de bala consoante nivel de dificuldade
  if (p1.level == 1){
...
//Constructor
  Player(String n, float x, float y) {
   ...
   public void drawme() { //spawn da imagem mediante parametros indicados + resize para tamanho pretendido
    for (int i = 0; i < PApplet.parseInt(p1.level*100); i++) { //precorrer o tamanho do array de inimigos
